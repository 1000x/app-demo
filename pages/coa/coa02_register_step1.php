...
<body>
	...
	<div class="page page-current" id='coa03_page01'>
		<header class="bar bar-nav">
			<a class="button button-link button-nav pull-left back" href="<?php echo site_url('coa01/');?>"> <span class="icon icon-left"></span> Back</a>
		...
		<div class="content">
			<div class="weui_msg">
				...
				<div class="weui_text_area">
					<p class="weui_msg_desc">名刺に記載しているのメールアドレスを入力してください。</p>
				</div>
				<div class="weui_text_area">
					<div class="weui_cells weui_cells_form">
						<div class="weui_cell">
							<div class="weui_cell_bd weui_cell_primary">
								<input class="weui_input" type="email" name="coa02_01001txt" id="coa02_01001txt" placeholder="メールアドレス を入力してください。">
							</div>
						</div>
					</div>
				</div>
				<div class="weui_opr_area">
					<p class="weui_btn_area">
						<a href="javascript:0;" class="weui_btn weui_btn_primary external" id="coa02_02001btn">次に進む</a>
					</p>
				</div>
